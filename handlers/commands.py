...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_service.is_admin(user_id):
        ...
        user_service.log_user_start(user_id, username, "админ")
        ...
        user_service.log_user_start(user_id, username, "пульт")
        ...
        user_service.log_user_start(user_id, username, "менеджер")
