...
from utils.state import (
    ...
    set_tel_choice, get_tel_choice, is_tel_choice_expired,
    clear_all_states, clear_tel_choice,
    set_quick_error_sip, get_quick_error_sip, is_quick_error_sip_expired,
    set_quick_error_code, get_quick_error_code, is_quick_error_code_expired,
