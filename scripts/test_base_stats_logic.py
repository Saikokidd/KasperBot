...
Локальное тестирование логики подсчёта base_stats_service

Запуск: python scripts/test_base_stats_logic.py
"""
...
# Тест 1: Простые данные (как на скрине)
test_data_15_12 = [
    {"поставщик": "3к_МСК_helphub", "итог_цвет": "ЗЕЛЕНЫЙ"},
    {"поставщик": "3к_МСК_helphub", "итог_цвет": "ЗЕЛЕНЫЙ"},
...
# Тест 2: Вторая дата
test_data_16_12 = [
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": "ЗЕЛЕНЫЙ"},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": "ЗЕЛЕНЫЙ"},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": "ЗЕЛЕНЫЙ"},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": "РОЗОВЫЙ"},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": ""},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": "ЗЕЛЕНЫЙ"},
    {"поставщик": "3к+Анон_реги_ТВЛ", "итог_цвет": ""},
    # ... и т.д.
]
...
def test_calculations():
    ...
    expected_15_12 = {
        ...
        "1к_регл_Анон": {"calls": 16, "recalls": 9, "bomzh": 1},
    ...
    print(f"     Бомжи: {total_bomzh} (ожидали 3)")
    print(f"     % перезвонов: {(total_recalls/total_calls*100):.0f}% (ожидали 46%)")
...
def test_percentage_calculation():
    ...
    test_cases = [
        ...
        ({"calls": 7, "recalls": 3}, 43),  # Округление
        ({"calls": 1, "recalls": 0}, 0),
